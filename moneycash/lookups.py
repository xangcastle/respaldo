...
class ProvedorLookup(LookupChannel):
    ...
    add_link = reverse('add_popup',
            kwargs={'app_label': 'compras',
                'model': 'provedor'})

    def get_query(self, q, request):
        return Provedor.objects.filter(empresa=get_current_user().empresa).filter(
            Q(name__icontains=q) | Q(code__istartswith=q)).order_by('name')
    ...
    def format_item_display(self, obj):
        return "<div class=""grp-row grp-cells-1 name ""><div class=""l-2c-fluid l-d-4""><div class=""c-1""><label>Nombre</label></div><div class=""c-2""><div class=""grp-readonly""><a href=""/admin/compras/provedor/%s"" onclick=""return showAddAnotherPopup(this);"">%s</a></div></div></div></div><div class=""grp-row grp-cells-2 grp-cells code identificacion ""><div class=""grp-cell l-2c-fluid l-d-4 code""><div class=""c-1""><label>Codigo</label></div><div class=""c-2""><div class=""grp-readonly"">%s</div></div></div><div class=""grp-cell l-2c-fluid l-d-4 identificacion""><div class=""c-1""><label class=""inline"">Ruc/cedula</label></div><div class=""c-2""><div class=""grp-readonly"">%s</div></div></div></div><div class=""grp-row grp-cells-1 telefono ""><div class=""l-2c-fluid l-d-4""><div class=""c-1""><label>Telefono</label></div><div class=""c-2""><div class=""grp-readonly"">%s</div></div></div></div><div class=""grp-row grp-cells-1 direccion ""><div class=""l-2c-fluid l-d-4""><div class=""c-1""><label>Direccion</label></div><div class=""c-2""><div class=""grp-readonly"">%s</div></div></div></div><div class=""grp-row grp-cells-2 grp-cells limite_credito saldo ""><div class=""grp-cell l-2c-fluid l-d-4 limite_credito""><div class=""c-1""><label>Limite credito</label></div><div class=""c-2""><div class=""grp-readonly"">%s</div></div></div><div class=""grp-cell l-2c-fluid l-d-4 saldo""><div class=""c-1""><label class=""inline"">Saldo</label></div><div class=""c-2""><div class=""grp-readonly"">%s</div></div></div></div>" %\
         (escape(obj.id),escape(obj.name), escape(obj.code),
            ...
            #<a href="/admin/compras/provedor/add/?_to_field=id" onclick="return showAddAnotherPopup(this);">