...
class ReciboAdmin(admin.ModelAdmin):
    list_display = ('area','equipo','contador_inicial','contador_final','total_copias','copia_diferencia','meta','cumplimiento')
...
class RequisaAdmin(admin.ModelAdmin):
    list_display = ('id','fecha','site_origen','tipo_requisa','str_detalle')
    list_filter = ('tipo_requisa','site_origen')
